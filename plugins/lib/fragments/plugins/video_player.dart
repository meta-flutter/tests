...
class VideoPlayerPluginPage extends StatefulWidget {
  const VideoPlayerPluginPage({Key? key, required this.title})
      : super(key: key);
...
class _VideoPlayerPluginState extends State<VideoPlayerPluginPage> {
